    ...
    <div className='footer'>
      ...
      <div className="footer-content">
        ...
        <div className="footer-social-links"> <svg className="footer-social-amoeba-svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 236 54">
          ...
          <a className="footer-social-link linkedin" href="" >
          <div className="ball"></div>
          </a>
          <a className="footer-social-link twitter" href="" >
          <div className="item3" >
          ...
          <a className="footer-social-link twitter" href="" title="log out" >
        <div className="item3">
          <span className="textItem"><FontAwesomeIcon icon={faArrowRightFromBracket} /></span>
        </div>
      </a>
      <a className="footer-social-link youtube" href="" onClick={handleContactUs} title="contact us">
        <div className="item2">
          <span className="textItem"><FontAwesomeIcon icon={faEnvelope} /></span>
        </div>
      </a>
      <a className="footer-social-link github" href="" onClick={handleShare} title="share">
        <div className="item">
